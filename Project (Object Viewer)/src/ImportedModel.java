...
// Class ImportedModel now extends Mesh
// This class is only responsible for creating
// vertices (with normals and texture coordinates)
// 
...
public class ImportedModel extends Mesh
{
